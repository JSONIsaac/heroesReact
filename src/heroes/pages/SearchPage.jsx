      ...
      <div className="row">
        ...
        <div className="col-7">
...

          {
            ...
            : (heroes.length === 0) 
            && <div className="alert alert-danger animate__animated animate__fadeInUp">No hero with <b>{q}</b></div>
          }

        {/* <div className="alert alert-primary" style={{ display: showSearch ? '' : 'none'}}>Search a hero</div>
        
        
        <div className="alert alert-primary" style={{ display: showError ? '' : 'none'}}>Search a hero</div> */}
